...
```{r eval=TRUE}
# I know it's a cyanobacteria
print.names.under.taxon(my.list = limony, taxon = "Cyanobacteria")

# Now I can step down the taxonomy until I find the correct spelling.
# I'll order by most abundant so that I find it easily.
print.names.under.taxon(my.list = limony, taxon = "Cyanobacteriia", sort.by = mean)
