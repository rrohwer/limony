...
# Now I can use this spelling to subset out Microcystis:
index <- get.taxon.indexes(my.list = limony, taxa = "Microcystis.Microcystaceae")
microcystis <- subset.by.taxa(my.list = limony, keep.index = index)
